...
<header class="site-header">
  ...
  <div class="site-search-wrap">
    ...
    <form class="site-search" action="<c:url value='/search.jsp'/>" method="get">
  ...
  <div class="header-actions">
    ...
    <!-- 프로필 드롭다운 -->
    <div class="profile-popover" id="profile-popover" role="menu" aria-labelledby="avatar-btn" hidden>
      <div class="profile-card">
        <div class="profile-row">
          ...
          <div class="meta">
            <strong class="name"><c:out value="${sessionScope.userName != null ? sessionScope.userName : 'Guest'}"/></strong>
            <div class="sub"><c:out value="${sessionScope.userEmail != null ? sessionScope.userEmail : ''}"/></div>
          </div>
        </div>

        <div class="divider"></div>

        <a href="<c:url value='/account.jsp'/>" class="menu-item" role="menuitem">내 정보</a>
        <a href="<c:url value='/settings.jsp'/>" class="menu-item" role="menuitem">설정</a>
