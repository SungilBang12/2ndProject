  ...
  <div class="menu">
    <section class="accordion" id="acc-sunset">
      ...
      <div id="acc-sunset-panel" class="panel" role="region" aria-label="Sunset 카테고리">
        ...
        <a href="<c:url value='/sunset-reco.jsp'/>">맛집 추천</a>
        <a href="<c:url value='/sunset-review.jsp'/>">맛집 후기</a>
      </div>
    </section>
  </div>
  ...
  <div class="menu">
    <section class="accordion" id="acc-equipment">
      ...
      <div id="acc-equipment-panel" class="panel" role="region" aria-label="Equipment 카테고리">
        <a href="<c:url value='/equipment-tips.jsp'/>">촬영 TIP</a>
        <a href="<c:url value='/equipment-reco.jsp'/>">장비 추천</a>
        <a href="<c:url value='/equipment-market.jsp'/>">중고 거래</a>
      </div>
    </section>
  </div>
  ...
  <div class="menu">
    <section class="accordion" id="acc-meeting">
      ...
      <div id="acc-meeting-panel" class="panel" role="region" aria-label="Meeting 카테고리">
        <a href="<c:url value='/meeting-gather.jsp'/>">'해'쳐 모여</a>
        <a href="<c:url value='/meeting-reco.jsp'/>">장소 추천</a>
      </div>
    </section>
  </div>
